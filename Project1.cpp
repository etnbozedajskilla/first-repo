...
int main()
{
 ...
 // Version 2
    ...
    {
        cout << "The largest number is: " << numbers_converted[2] << endl;
    }

 // Version 3
    cout << endl << " Version 3: " << endl;
    cout << "The largest number is: " << max(max(numbers_converted[0], numbers_converted[1]), numbers_converted[2]) << endl;
}
